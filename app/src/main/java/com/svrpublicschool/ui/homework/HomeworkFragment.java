...
public class HomeworkFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        homeworkAdapter = new HomeworkAdapter(this, classEntities);
        initialise(view);
    ...
    private void getClassesList() {
        ...
        classRef.orderByChild("pos").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                homeworkAdapter.updateList(classEntities);
            }
    ...
    private void initialise(View view) {
        ...
        rvClassList.setAdapter(homeworkAdapter);
        if (activity != null)
    ...
    public void openAddClassBottomSheet() {
        ...
        AddClassBottomSheetDialog addClassBottomSheetDialog = new AddClassBottomSheetDialog(HomeworkFragment.this.getActivity(), result -> {
            if (result == 1) { //success
                Toast.makeText(HomeworkFragment.this.getActivity(), "Task Completed Success", Toast.LENGTH_SHORT).show();
            } else { // Failure
                Toast.makeText(HomeworkFragment.this.getActivity(), "Task Failed", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public class LoadLocalClassList extends AsyncTask<Void, Void, List<ClassEntity>> {
        ...
        protected List<ClassEntity> doInBackground(Void... voids) {
            ...
            if (prefData.equals("")) {
                ...
                jsonArray = Utility.readAssetsJsonFile(HomeworkFragment.this.getActivity(), "classes.json");
            } else {
    ...
    public void redirectToGroupChat(ClassEntity classEntity) {
        ...
        groupDetailsEntity.setFid(classEntity.getfId());
        groupDetailsEntity.setGpName("Homework - " + classEntity.getClassName());
        groupDetailsEntity.setGpIcon("");

        Intent intent = new Intent(this.getActivity(), GroupChatActivity.class);
        intent.putExtra(Constants.INTENT_PARAM_GROUP, groupDetailsEntity);
