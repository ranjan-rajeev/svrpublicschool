...
*/
    ...
    public class BindGallery extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... voids) {
            ...
            try {
                ...
                Gson gson = new Gson();
                List<BannerEntity> bannerEntities = gson.fromJson(FirebaseHelper.getGalleryList(), new TypeToken<List<BannerEntity>>() {
                }.getType());
        ...
        protected void onPostExecute(List<String> list) {
            ...
            if (!Utility.isListEmpty(list)) {
                galleryAdapter = new GalleryAdapter(GalleryFragment.this, list);
                rvGallery.setAdapter(galleryAdapter);
            }
        }
    }
